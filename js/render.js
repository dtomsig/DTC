...
const MAX_SAMPLES = 15, SENSITIVITY = 60;
let rotate = false;
...
document.getElementById('id_canvas_main').onmousemove = on_canvas_move;
document.getElementById('id_canvas_main').onmouseleave = on_canvas_leave;
...
function on_canvas_move(event)
{
    ...
    if(rotate === true)
        main_camera.traverse_arcball(delta_x * SENSITIVITY / 6000, delta_y * SENSITIVITY / 6000);
    rotate = true;
}
