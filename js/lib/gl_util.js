...
class camera
{
    ...
    traverse_arcball(rads_x, rads_y)
    {
        ...
        // 4. Moving the mouse left and right rotates the forward vector and right vector across the up camera axis.
        vec3.transformQuat(this.fwd_vec, this.fwd_vec, this.rot_horiz);   // The right vector is calculated in step 5.
        ...
        vec3.normalize(this.fwd_vec, this.fwd_vec);   // normalized because "eye_pos" drifts, causing the camera to move.
...
class model
{
    ...
    compute_mdl_mtx()
    {
        ...
        vec3.normalize(this.right_vec, this.right_vec);   // All three vectors are normalized by this point. The up
                                                          // vector is normalized in set_up_vec().
